...
//* COMPONENT START
//-------------------------------------------------------------
function TableRecordsCountChart({ displayTitle, data, displayLimit, onDisplayLimitChange, displayData = true }) {
...
export default TableRecordsCountChart;
